...
class HomeModel
{
    ...
    public function getTotalIncomesThisMonth($userId)
    {
        try {
            ...
            error_log("Error in getTotalIncomesThisMonth: " . $e->getMessage());
            return 0;
        }
    }
    ...
    public function getTotalExpensesThisMonth($userId)
    {
        try {
            ...
            error_log("Error in getTotalExpensesThisMonth: " . $e->getMessage());
            return 0;
        }
    }
    ...
    public function getIncomeCategoriesForChart($userId)
    {
        try {
            ...
            error_log("Error in getIncomeCategoriesForChart: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function getExpenseCategoriesForChart($userId)
    {
        try {
            ...
            error_log("Error in getExpenseCategoriesForChart: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function getExceededLimits($userId)
    {
        try {
            ...
            error_log("Error in getExceededLimits: " . $e->getMessage());
            return [];
        }
    }
}
